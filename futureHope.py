...
def get_afirmacoes():
    ...
    afirmacoes.append(
        [
            "A COVID-19 gerou a sexta grande pandemia mundial.",
            "V",
            "Houve a gripe espanhola em 1918 e outras.",
        ]
    )
    afirmacoes.append(
        [
            "Menos de 700 mil mortes foram causadas através da COVID-19.",
            "F",
            "No Brasil foram mais de 500 mil.",
        ]
    )
    afirmacoes.append(
        [
            "Países iniciaram um plano de vacinação de forma idêntica.",
            "F",
            "Alguns países produziram antes que outros.",
        ]
    )
    afirmacoes.append(
        [
            "O vírus da COVID-19 não se reproduzia sozinho, ele precisa de uma célula hospedeira.",
            "V",
            "Disso depende a infecção.",
        ]
    )
    afirmacoes.append(
        [
            "O vírus da COVID-19 não estava presente na saliva.",
            "F",
            "Pode ser transmitido por tosse ou conversa.",
        ]
    )
    afirmacoes.append(
        [
            "O COVID-19 afetava principalmente as células do pulmão e intestino.",
            "V",
            "Afetados sentem dificuldades para respirar",
        ]
    )
    afirmacoes.append(
        [
            "Apenas 2,2% de toda água do mundo era água doce.",
            "V",
            "Temos apenas 0,3% disponível para consumo.",
        ]
    )
    afirmacoes.append(
        [
            "O setor agrupecuário não foi o maior causador de poluição no Brasil.",
            "F",
            "Não foi a indústria.",
        ]
    )
    afirmacoes.append(
        [
            "Uma tonelada de papel reciclado poupava cerca de 22 árvores.",
            "V",
            "Com apenas 1 árvore se produzia milhares de kilos.",
        ]
    )
    return afirmacoes
...
while historia:
    ...
    texto_1 = minhafonte.render(
        "O ano é 2107 e um viajante chamado Josh voltou ao século XXI.",
        False,
        (0, 0, 0),
    )
    texto_2 = minhafonte.render(
        "Porque seu mundo está devastado e a única esperança sou eu.", False, (0, 0, 0)
    )
    texto_3 = minhafonte.render(
        "Toda informação mundial foi perdida, então decidi ajudar.", False, (0, 0, 0)
    )
    texto_4 = minhafonte.render(
        'Ele me disse: "You are the Future Hope".', False, (0, 0, 0)
    )
    ...
    # Atualiza sempre que eu fizer algo novo
...
while menu:
    ...
    # Exibe eventos capturados do jogo
    # print(event)
...
def jogar():
    ...
    def pontuacao():
        ...
        while pontuacao:
            ...
            texto_pontuacao = minhafonte.render(
                "Pontuação Final: " + str(vida), False, (0, 0, 0)
            )
